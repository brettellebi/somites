...
```{r}
RESULTS_DIR = "/nfs/research/birney/users/ian/somites/association_testing/20220118"
...
gwas_tests_wimiss = purrr::map(bin_lengths, function(BIN_LENGTH){
  readRDS(file.path(lts_dir, "association_testing/20220118_test/test_results", paste(BIN_LENGTH, ".rds", sep = "")))
})
```
...
```{r, eval = F}
PERMUTATIONS_DIR = file.path(lts_dir, "association_testing/20220118")
