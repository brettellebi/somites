...
df_list$`5000` %>%
  ...
  ggplot() +
    ...
    theme_bw()
# Save
ggsave(here::here("docs/plots/20211027_ratio_v_state.png"),
       device = "png",
       width = 8,
       height = 5,
       units = "in",
...
```{r, out.width='80%'}
knitr::include_graphics(here::here("docs/plots/20211027_ratio_v_state.png"))
```
...
```{r, include = F}
base_cov_df_chr = readRDS(here::here("data/20211027_base_cov_per_chr.rds"))
```
...
```{r, eval = F, echo = F}
saveRDS(bb_list, here::here("data/20211027_bb_list.rds"))
```

```{r, include = F}
bb_list = readRDS(here::here("data/20211027_bb_list.rds"))
```
...
knitr::include_graphics(here::here("docs/plots/20211027_karyoplot_5000.png"))
```

Don't show other bin lengths because they look the same.

```{r, eval = F, fig.cap = "Bin length: 10 kb"}
knitr::include_graphics(here::here("docs/plots/20211027_karyoplot_10000.png"))
```

```{r, eval = F, fig.cap = "Bin length: 15 kb"}
knitr::include_graphics(here::here("docs/plots/20211027_karyoplot_15000.png"))
```

```{r, eval = F, fig.cap = "Bin length: 20 kb"}
knitr::include_graphics(here::here("docs/plots/20211027_karyoplot_20000.png"))
```
...
png(here::here("docs/plots/20211027_rrm_heatmap.png"),
    width = 20,
    height = 20,
    units = "in",
    res = 400)
...
```{r}
knitr::include_graphics(here::here("docs/plots/20211027_rrm_heatmap.png"))
```