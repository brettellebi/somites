...
Removed use of (almost) all wrappers in Snakemake pipeline. Now all rules are containerised other than pulling the Ensembl sequence. 

[NOTE]{color="red"}: Install `plotly` in R container.
