...
```{r, eval = F}
saveRDS(base_cov_df_chr, here::here("data/20210629_base_cov_per_chr.rds"))
```

```{r, include = F}
base_cov_df_chr = readRDS(here::here("data/20210629_base_cov_per_chr.rds"))
```
...
```{r}
ggsave(here::here("plots/20210618_gt_freqs_sites.png"),
       device = "png",
       width = 10,
       height = 5.8,
       units = "in",
